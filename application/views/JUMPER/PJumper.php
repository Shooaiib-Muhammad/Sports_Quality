...
<div class="page-wrapper">
  ...
  <div class="col-md-4">
	...
	<select id="designation" class="form-select">
	  ...
	  <option >abc</option>
	  <option >fahad ki jan moosa</option>
	  <option >jaaaaz</option>
      <option>wadda jaaaz </option>
    </select></div>
  </div>
  ...
  <div class="col-12">
    <!-- <button type="submit"  class="btn btn-primary"onclick="onsave()">Submit</button> -->
...
<div class="col-md-12" id="DataFromC">
							...
							let length = paramsSplit.length;
							console.log(paramsSplit[length-1])
							if(paramsSplit[length-1] == "1"){
							...
							url = "<?php echo base_url('index.php/QI/AssignmentLcontroller/AssignmentItemsListdelete');?>?id="+TID
...
function onsave(){
  ...
  data = {
      ...
      url = "<?php echo base_url(''); ?>JUMPER/P_Jumper/insertion/"
...
<script>
	window.onload=function(){
		url='<?php echo base_url('JUMPER/P_Jumper/getemployeeData') ?>'
$.post(url,function(data){
console.log(data)
let table=''
table+=`<table class="table table-hover table-responsive"  id="table_id">
								<thead>
									<tr>
									<th scope="col">TID</th>
											...
											data['dataTable'].forEach(element=>{
												table+=`<tr>
												  <td>${element.TID}</td>
													...
													<td>${element.sectionid}</td>
													<td>${element.desigid}</td>
													
													
													<td>
													<button type='button' onclick=editRecord(${element.TID}) style='display: inline-block;' id=btn,".${element.TID}" class='btn btn-primary btn-xs updatebtn' >Update</button>
													</td>
													<td>
													<button type='button' onclick=editRecord(${element.TID}) style='display: inline-block;'  id=btn,".${element.TID}" class='btn btn-danger btn-xs undobtn'>Delete</button>
													</td>
	...
	function editRecord(id){
		alert(id);
		url="<?php echo base_url(); ?>/JUMPER/P_Jumper/edit/"
