            ...
            <ul id="js-nav-menu" class="nav-menu">
                ...
                if ($lab == '1') { ?>
                    ...
                    <li>
                        <a href="#" title="Theme Settings" data-filter-tags="theme settings">
                            <i class="fal fa-vial"></i>
                            <span class="nav-link-text" data-i18n="nav.theme_settings">Edit Material Types</span>
                        </a>
                        <ul>
                            <li>
                                <a href="<?php echo base_url(
                                    ...
                                    <span class="nav-link-text" data-i18n="nav.theme_settings_how_it_works">Edit Material
                                        Type</span>
                                </a>
                            </li>
