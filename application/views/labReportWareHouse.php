    ...
    <div class="page-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <!-- <div class="subheader">
                        <h1 class="subheader-title">
                            <span><i class='subheader-icon fal fa-chart-area'></i> Lab WareHouse Reports</span>
                    ...
                    <div class="col-lg-12" style="margin-bottom:20px">
                        ...
                        <div class="col-md-6 offset-md-3 offset-0 table-responsive" hidden>
                                ...
                                <div class="panel-container show">
                                    <div class="panel-content">
                                        <div class="demo-v-spacing">
                                            <form method="post" enctype="multipart/form-data" action='<?php echo base_url('LabController/uploadFgtFile'); ?>'>
                                                <div class="card-body">
                                                    <?php if ($this->session->flashdata('info')) : ?>
                                                        <h2 class="text-success text-center"> <?php echo $this->session->flashdata('info') ?></h2>
                                                    <?php endif; ?>
                                                    <?php if ($this->session->flashdata('error')) : ?>
                                                        <h2 class="text-danger text-center"> <?php echo $this->session->flashdata('error') ?></h2>
                                                    <?php endif; ?>
                                                    <div class="alert alert-warning alert-dismissible fade show" role="alert" id="alertShown" style="display: none;">
                                                        Kindly wait for server response!
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <div class="row mt-2 mb-2">
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <input type="file" name="freshImage" id="freshImage" class="form-control">
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <label for="afterShooterImage">After Shooter Image</label>
                                                                                <input type="file" name="afterShooterImage" id="afterShooterImage" class="form-control">
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <label for="hydrolysisImage">Hydrolysis Image</label>
                                                                                <input type="file" name="hydrolysisImage" id="hydrolysisImage" class="form-control">
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <label for="drumImage">Drum Image</label>
                                                                                <input type="file" name="drumImage" id="drumImage" class="form-control">
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <table border="1" style="margin-top: 5px; width:96%;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="padding: 0px; text-align:left;">1</td>
                                                                </tr>
                                                                <tr>
                                                        ...
                                                        <div style="padding-left:30px;padding-right:30px;">
                                                            <table border="1">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>lAB NO.</td>
                                                                        <th style="text-align: center;" id="labNoFGT"></th>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>CSS NO.</td>
                                                                        <th style="text-align: center;" id="cssNoFGT"> </th>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Receiving Date:</td>
                                                                        <th style="text-align: center;" id="receiveDateFGT"></th>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Testing Date</td>
                                                                        <th style="text-align: center;" id="testingDataFGT"></th>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Issue Date</td>
                                                                        <th style="text-align: center;" id="issueDateFGT"></th>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Enviromental Cond.</td>
                                                                        <th style="text-align: center;" id="environmentalCondFGT"></th>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Test Acc. To Cat.</td>
                                                                        <th style="text-align: center;" id="testAccToCatFGT"></th>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                                        ...
                                                                        <table border="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width:100%; text-align:center;">By Oman Sb - oman@forward.pk</td>
                                                                                </tr>
                                                                                <tr>
                        ...
                        <div class="col-md-12  table-responsive">
                            ...
                            <div id="" class="">
                                <div class="panel-hdr">
                                    <h2>
                                        <span>Lab WareHouse Reports</span>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex">
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/adhesionView') ?>">
                                                            <button class="btn btn-primary">Adhesion Material</button>
                                                        </a>
                                                    </div>
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/bladerView') ?>">
                                                            <button class="btn btn-info">Bladder</button>
                                                        </a>
                                                    </div>
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/cartonView') ?>">
                                                            <button class="btn btn-warning">Carton</button>
                                                        </a>
                                                    </div>
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/CSMMaterialView') ?>">
                                                            <button class="btn btn-danger">CSM Material</button>
                                                        </a>
                                                    </div>
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/fabricView') ?>">
                                                    ...
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/materialView') ?>">
                                                            <button class="btn btn-warning">Material</button>
                                                        </a>
                                                    </div>
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/MsMaterialView') ?>">
                                                            <button class="btn btn-danger">MS Material</button>
                                                        </a>
                                                    </div>
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/MsThreadView') ?>">
                                                            <button class="btn btn-success">MS Thread</button>
                                                        </a>
                                                    </div>
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/polyBagView') ?>">
                                                            <button class="btn btn-dark">PolyBag Material</button>
                                                        </a>
                                                    </div>
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/SrBladderView') ?>">
                                                            <button class="btn btn-info">SR Bladder</button>
                                                        </a>
                                                    </div>
                                                    <div class="p-1">
                                                        <a href="<?php echo base_url('LabController/threadView') ?>">
                                                            <button class="btn btn-warning">Thread</button>
                                                        </a>
                                                    </div>
                        ...
                        <script>
                            ...
                            $('#searchFGTtest').on('click', function() {
                                ...
                                if (!factoryCode) {
                                    alert("Please select a factory code");
                                    return;
                                }
                                url = '<?php echo base_url('LabController/getFGTCarcass'); ?>';
                                $.post(url, {
                                    'date1': date1,
                                    'date2': date2,
                                    ...
                                    if (data) {
                                        ...
                                        data.forEach(element => {
                                            fgtHtml += `<tr>
                                                ...
                                                <td><span class="badge badge-warning p-1">Fatima Rasheed </span></td>
                                ...
                                $.post(url1, {
                                    ...
                                    function(data, status) {
                                        if (data) {
                                            ...
                                            $('#testingDataFGT').html(data[0]['Testing_Date']);
                            ...
                            function deleteFGTTestHeadDetails(TID, CssNo) {
                                let confirmm = confirm("Are you sure you want to delete?");
                                if (confirmm) {

                                    url1 = '<?php echo base_url('LabController/deleteFGTTestHeadDetails'); ?>'
                                    $.post(url1, {
                                            TID: TID
                                        },
                                        function(data, status) {
        ...
        <script>
            ...
            $("#submitData").click(function(e) {
                ...
                // readXlsxFile(fileSelectStore).then(function(rows) {
                //     console.log("file all data ", rows);
                ...
                fileReader.onload = (e) => {
                    ...
                    filelist.forEach(element => {
                        if (element.LABNO != "" && element.CSSNO != "" && element.TestingDate != "") {
                            $("#submitData").css("display", "none");
                            $("#sendHeaderValues").css("display", "block");
                            let arrayHead = [element.LABNO, element.CSSNO, element.ReceivingDate, element.TestingDate, element.IssueDate, element.EnvironmentalCond, element.TestAccToCat, element.COVERMAT, element.BACKING, element.BLADDER, element.BALLTYPE, element.FIFAStamp, element.Productionmonth, element.TESTTYPE, element.MAINMATCOLOR, element.PRINTINGCOLORS, element.Article, element.Working, element.RESULT, element.TESTEDBY];
                            let arrayBody = [element.TEST, element.METHOD, element.CONDITION, element.UNIT, element.CAT1, element.CAT2, element.CAT3, element.MIN, element.MAX, element.REMARKS, ']'];

                            HeaderArray.push(arrayHead);
                            ChildArray.push(arrayBody);
                        } else {
                            alert("Lab No and CSS No is required!");
                ...
                //                     let arrayBody = ["", "", element.Date, element.BatchReference, element.Articleno, element.Standard, element.MaximumForce, element.AverageForce, element.Comments, element.MaximumForceInch, ']'];
                //                     HeaderArray.push(arrayHead);
                //                     ChildArray.push(arrayBody)
                //                 } else {
                //                     let arrayBody = [testNumber, PONumber, element.Date, element.BatchReference, element.Articleno, element.Standard, element.MaximumForce, element.AverageForce, element.Comments, element.MaximumForceInch, ']'];
                //                     ChildArray.push(arrayBody)
                //                 }
                //             });
                //             $("#headerData").val(HeaderArray);
