...
<table class="table table-hover " style="border: 0px gray solid; margin-top:50px;">
...
<td style="text-align: center;"><?php echo $Size;?></td>
      <td style="text-align: left;" style="width: 10%;"><?php echo $MaterialName;?></td>
<td style="text-align: center;"><?php echo $AirPBC;?> </td>
      <td style="text-align: center;width:5%;"><?php echo $AirPAC;?></td>
<td style="text-align: center;" class="Diff">0<?php echo $AirDifference;?></td>
      <td style="text-align: center;width:5%;"><?php echo Round($CarcasWBB);?> </td>
<td style="text-align: center;width:5%;"><?php echo Round($CarcasWAB);?> </td>
      <td style="text-align: center;" class="Diff"><?php echo Round($WeightDifference);?> </td>
<td style="text-align: center;width:5%;"><?php echo $CarcasCirBB1;?> </td>
      <td style="text-align: center; width:5%;"><?php echo $CarcasCirBB2;?></td>
<td style="text-align: center;" class="Diff">0<?php echo $CirBDiffenence;?></td>
      <td style="text-align: center;width:5%;"><?php echo $CarasCirAB1;?></td>
<td style="text-align: center;width:5%;"><?php echo $CarasCirAB2;?></td>
      <td style="text-align: center;" class="Diff">0<?php echo $CirADifference;?></td>
