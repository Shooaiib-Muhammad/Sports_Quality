            ...
            <div class="page-inner">
                ...
                <div class="page-content-wrapper">
                        ...
                        <div class="col-lg-12" style="margin-bottom:20px">
                            ...
                            <div class="subheader">
                                <h1 class="subheader-title">
                                    <i class='subheader-icon fal fa-chart-area'></i>SMV Notifications</span>
                                    ...
                                    <div id="right-panel" class="right-panel">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="card mb-3 ">
                                                ...
                                                <!-- <div class="col-md-5">
                                                    ...
                                                    <div class="col-md-2 mt-5">
                                                            ...
                                                            <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#330066">
                                                                <div class="">
                                                                    <h4>Current Day Notifications</h4> 
                                                                    <h3 class="display-4 d-block l-h-n m-0 fw-500">

                                                                        <!-- <small  class="m-0 l-h-n" style="font-weight:bold;">Notifications</small> -->
                                                ...
                                                <div class="row"> 
                                                 <div class="col-md-12 ml-2" id="empData"></div>
                                        ...
                                        <script>
                                            ...
                                            function samData(){
                                                $("#empData").html(' ');
                                                url= "<?php echo base_url('MIS/Efficiency/samValueNotification') ?>"
                                                $.post(url,function(data){
                                                    // console.log("Data is ",data);
                                                    length= data.length;
                                                    console.log("Data length is ",length);
                                                    $("#notifyData").html(length);
                                                    var table = '';
                                                    table += ` <table class="table table-responsive-xl " id="samTable">
                                                    <thead>
                                                    <tr>
                                                        <th>Factory Code</th>
                                                        <th>Art Size</th>
                                                    ...
                                                    data.forEach(e=>{
                                                        table += `<tr>
                              <td> ${e.FactoryCode}</td>
                              <td contentEditable="true"> ${e.ArtSize}</td>
                              <td contentEditable="true"> ${e.ArtCode}</td>
                              <td contentEditable="true">  ${e.Datename}</td>
                    ...
                    $('#searchRange').on('click',function(e){
                        ...
                        // alert(startDate);
                        // $newdate = str_replace('-', '/', $startDate );
                        // alert($newdate);
                    // $newDatestart = Date("m/d/Y", strtotime($startDate));
                    // alert($newDatestart)

                        let  url= "<?php echo base_url('MIS/Efficiency/samValueNotificationDate') ?>"
                        $.post(url,{'start-date':startDate,'end-date':endDate},function(data){
                            console.log("Data of Date is",data);
                            $("#empData").html("");
                            var table = '';
                                                    table += ` <table class="table table-responsive-xl " id="samTable">
                                                    <thead>
