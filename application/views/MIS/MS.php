            ...
            <main id="js-page-content" role="main" class="page-content">
                ...
                <ol class="breadcrumb page-breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url(
                                                                ...
                                                                <li class="breadcrumb-item"> Machine Stitch Ball</li>
                    ...
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class='subheader-icon fal fa-chart-area'></i>MS (Machine Stitch Ball)</span>
...
<div style="margin-top:18px" class="col-lg-12">
<div class="card">
