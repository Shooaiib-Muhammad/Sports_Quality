...
if ($this->session->userdata('userStus') == 1) { ?>
  ...
  <body>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <div class="col-xl-12" id="defaultLoadGant">
        <div class="card">
          <div class="card-body">
            <!-- <div class="row"> -->
            <!-- <div class="col-sm-4">
      ...
      <div class="col-xl-12" id="customLoadGant" style="display: none;">
        <div class="card">
          <div class="card-body">
            <!-- <div class="row"> -->
            <!-- <div class="col-sm-4">
      ...
      <div class="col-xl-12" id="defaultBarLineChart">
        <div class="card">
          <div class="card-body">
            <!-- <div class="row"> -->
            <!-- <div class="col-sm-4">
      ...
      <script>
        ...
        // url  : "<?php echo base_url('/Developement/loadArticle'); ?>",
        // method: "GET",
      ...
      <script>
        ...
        window.onload = function() {
          ...
          $.ajax({
            ...
            url: "<?php echo base_url('/Developement/loadArticleAll'); ?>",
            method: "GET",
            success: function(data) {
          ...
          url3 = '<?php echo base_url('Developement/CallDataDefault'); ?>'
          ...
          url = '<?php echo base_url('Developement/getGantCurrentDateData'); ?>'
      ...
      <script>
        function CallCombox() {
          Domain = $('#Select').val();
          url = "<?php echo base_url('Carcas/fact2/'); ?>" + Domain
          //alert(Domain);
          //  alert(url);
        ...
        function MainFunction() {
          ...
          if ($('#filterationSelection').val() == "All") {
            ...
            if (articleCode == "All" && typeofProject == "All") {
              ...
              url4 = '<?php echo base_url('Developement/CallDataRangeData'); ?>'
              ...
              url1 = '<?php echo base_url('Developement/getGantDateRangeData'); ?>'
              ...
              url2 = '<?php echo base_url('Developement/getCustomTableData'); ?>'
...
<li>
              ...
              $.ajax({
                ...
                url: "<?php echo base_url('/Lab/custompie'); ?>",
                method: "GET",
                data: {
                  "c_date": c_date,
                  "e_date": e_date
              ...
              $.ajax({
                ...
                url: "<?php echo base_url('/Lab/customtable'); ?>",
                method: "GET",
                data: {
                  "c_date": c_date,
                  "e_date": e_date
            ...
            //////////////////////////////////////////// Article Code Wise Data /////////////////////////////////////////
              ...
              url4 = '<?php echo base_url('Developement/CallDataRangeDataArticleCode'); ?>'

              $.post(url4, {
                  "startDate": c_date,
                  "endDate": e_date,
                  "article_code": articleCodevalue
                },
                function(data, status) {
              ...
              url1 = '<?php echo base_url(
                        'Developement/getGantDateRangeDataArticleCode'
                      ); ?>'
              ...
              url2 = '<?php echo base_url('Developement/getCustomTableDataArticleCode'); ?>'
      ...
      <tbody>`;
              ...
              $.ajax({
                ...
                url: "<?php echo base_url('/Developement/customload'); ?>",
                method: "GET",
                data: {
                  "c_date": c_date,
                  "e_date": e_date
...
<li>
              ...
              $.ajax({
                ...
                url: "<?php echo base_url('/Lab/customtableArticleCode'); ?>",
                method: "GET",
                data: {
                  "c_date": c_date,
                  "e_date": e_date,
              ...
              url4 = '<?php echo base_url('Developement/CallDataRangeDataType'); ?>'
              ...
              ///////////////////////////// Gant Chart Custom Date //////////////////////////////
              url1 = '<?php echo base_url('Developement/getGantDateRangeDataType'); ?>'
              ...
              url2 = '<?php echo base_url('Developement/getCustomTableDataType'); ?>'
...
<li>
              ...
              url4 = '<?php echo base_url(
                        'Developement/CallDataRangeDataTypeArticleCode'
                      ); ?>'
              ...
              ///////////////////////////// Gant Chart Custom Date //////////////////////////////
              url1 = '<?php echo base_url(
                        'Developement/getGantDateRangeDataTypeArticleCode'
                      ); ?>'
              ...
              url2 = '<?php echo base_url(
                        'Developement/getCustomTableDataTypeArticleCode'
                      ); ?>'
...
<li>
            ...
            let articleCodevalue = $("#articlePlace").val()
            url4 = '<?php echo base_url('Developement/CallSpecificDataArticleCode'); ?>'
            ...
            ///////////////////////////// Gant Chart Custom Date //////////////////////////////
            url1 = '<?php echo base_url(
                      'Developement/getGantSpecificDataArticleCode'
                    ); ?>'
            ...
            url2 = '<?php echo base_url('Developement/getCustomTableDataSpecificArticleCode'); ?>'
...
<li>
            ...
            let Typevalue = $("#processPlace").val()
            url4 = '<?php echo base_url('Developement/CallSpecificDataType'); ?>'
            ...
            ///////////////////////////// Gant Chart Custom Date //////////////////////////////
            url1 = '<?php echo base_url('Developement/getGantSpecificDataType'); ?>'
            ...
            url2 = '<?php echo base_url('Developement/getCustomTableDataSpecificType'); ?>'
...
<li>
            ...
            url4 = '<?php echo base_url('Developement/CallSpecificDataSeason'); ?>'
            ...
            ///////////////////////////// Gant Chart Custom Date //////////////////////////////
            url1 = '<?php echo base_url('Developement/getGantSpecificDataSeason'); ?>'
            ...
            url2 = '<?php echo base_url('Developement/getCustomTableDataSpecificSeason'); ?>'
