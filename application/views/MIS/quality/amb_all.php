...
<h2 class="bg-primary-200 text-light text-white p-2 text-center">Airless Mini Ball Packing Station Wise QC ( <?php format($start_date); echo " To "; format($end_date) ?> )</h2>
