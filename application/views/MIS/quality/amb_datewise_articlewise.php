<div id="panel-1" class="panel">
    ...
    <h2 class="bg-primary-200 text-light text-white p-2 text-center">Airless Mini Ball OverAll Forming QC ( <?php format($start_date);
                                                                                                            echo " To ";
                                                                                                            format($end_date) ?> )</h2>
    <table class="table table-hover table-bordered table-responsive" id="forming_overall-table">
        ...
        <tbody>
            ...
            ?>
            <?php
            if(isset($data_overall)){
             foreach ($data_overall as $d) {; ?>
                <tr>
                    <?php
                    $passsss = ($d->Pass) + $passsss;
                    $Checked = ($d->TotalChecked) + $Checked;
