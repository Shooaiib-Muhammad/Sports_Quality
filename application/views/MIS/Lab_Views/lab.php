        ...
        <div class="position-relative form-group">
                                ...
                                <select  id="articlePlace" class="form-control">
                                     <option value="All" selected>All</option>
                                        ...
                                        <div class="col-md-12" id="loadChart">
                                            <div class="card">
   ...
   Lab Supplier Wise
    ...
    Material Wise 
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            ?>
                                            <div id="appenTitle" class="card-header mt-2 mb-2" class= style="color:white">
                                            ...
                                            function MainFunction() {
                                                ...
                                                if (supplier == 2) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        url: "<?php echo base_url('MIS/Lab/getDatewiseSupplier'); ?>",
                                                        method: "GET",
                                                        data: {
                                                            "c_date": c_date,
                                                            "e_date": e_date,
                ...
                <td>${item.Result}</td>
                                                            ...
                                                            var appendTitle = '';
                                                            appendTitle += `<h4>${data['supplier'][0].Supplier_Name} wise </h4>`
                                                    ...
                                                    $("#loadChart").css("display", 'none')
                                                    $("#CustomChart").css("display", 'block')
                                                    $.ajax(url: "<?php echo base_url('/MIS/Lab/getDatewiseMaterial'); ?>",method: "GET",data: {"c_date": c_date,"e_date": e_date,"materialName": materialName},success: function(data) {
