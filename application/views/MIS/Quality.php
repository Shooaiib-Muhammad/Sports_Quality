...
$Year=date('Y');
$Day=date('d');
$CurrentDate= date('Y-m-01', strtotime(date('Y-m')." -10 month"));
...
$FCName="Machine Stitched Ball";
}elseif($FC=='B34006'){
$FCName="Airless Mini Ball";
}


?>
<form action="<?php echo base_url('MIS/Quality/GetQCData'); ?>" method="POST">
<div class="col-md-3">
