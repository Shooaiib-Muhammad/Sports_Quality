                                        ...
                                        <ul id="js-nav-menu" class="nav-menu">
                                                <li class="active open">
                                                        ...
                                                        <ul>
                                                                ...
                                                                <li>
                                                                        <a href="<?php echo base_url('index.php/main/dmms_dashboard') ?>" title="DMMS Dashboard" data-filter-tags="application intel analytics dashboard">
                                ...
                                <main id="js-page-content" role="main" class="page-content">
                                        ...
                                        <div class="subheader">
                                                <h1 class="subheader-title">
                                                        <i class='subheader-icon fal fa-chart-area'></i>Ideal Machines</span>
                                        ...
                                        <div class="col-lg-12" style="margin-bottom:20px">
                                                ...
                                                <div class="col-12 table-responsive">
                                                        ...
                                                        <div id="panel-1" class="panel">
                                                                <div class="panel-hdr">
                                                                        <h2>
                                                                                DMMS <span class="fw-300"><i>Ideal Machines</i></span>
                                                                        </h2>
                                                                                        ...
                                                                                        <div class="table-responsive-lg" id="Data">
                                                                                                <table class="table table-striped table-hover table-sm">
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                                ...
                                                                                                                ?>
                                                                                                                <?php foreach ($idealmachines as $k) : ?>
                                                                                                                        <?php
                                                                                                                        $TID = $k['SecID'];
                                                                                                                        ?>
                                                                                                                        <tr>
                                                                                                                                <form>
                                                                                                                                        <td><?php echo $k['DeptName'] ?></td>
                                                                                                                                        <td><?php echo  $k['SecName'] ?></td>

                                                                                                                                        <td>
                                                                                                                                                <input type="hidden" name="id" value="<?php echo $TID ?>">
                                                                                                                                                <?php
                                                                                                                                                $OEEStatus = $k['OEEStatus'];
                                                                                                                                                $ID = $k['SecID'];
                                                                                                                                                $OEEStatus;
                                                                                                                                                if ($OEEStatus == 1) {
                                                                                                                                                ?>
                                                                                                                                                        <div class="custom-control custom-switch">
                                                                                                                                                                <input type="checkbox" name="onoffswitch" class="custom-control-input" id="OEEStatus<?php echo $ID ?>" checked>
                                                                                                                                                                <label class="custom-control-label" for="OEEStatus<?php echo $ID ?>"></label>
                                                                                                                                                        </div>
                                                                                                                                                <?php
                                                                                                                                                } else {
                                                                                                                                                ?>
                                                                                                                                                        <div class="custom-control custom-switch">
                                                                                                                                                                <input type="checkbox" name="onoffswitch" class="custom-control-input" id="OEEStatus<?php echo $ID ?>">
                                                                                                                                                                <label class="custom-control-label" for="OEEStatus<?php echo $ID ?>"></label>
                                                                                                                                                        </div>
                                                                                                                                                <?php
                                                                                                                                                }
                                                                                                                                        ...
                                                                                                                                        <td>
                                                                                                                                                ...
                                                                                                                                                <?php
                                                                                                                                                $BECStatus = $k['BECStatus'];
                                                                                                                                                $ID = $k['SecID'];
                                                                                                                                                $BECStatus;
                                                                                                                                                if ($BECStatus == 1) {
                                                                                                                                                ?>
                                                                                                                                                        <div class="custom-control custom-switch">
                                                                                                                                                                <input type="checkbox" name="onoffswitch" class="custom-control-input" id="BECStatus<?php echo $ID ?>" checked>
                                                                                                                                                                <label class="custom-control-label" for="BECStatus<?php echo $ID ?>"></label>
                                                                                                                                                        </div>
                                                                                                                                                <?php
                                                                                                                                                } else {
                                                                                                                                                ?>
                                                                                                                                                        <div class="custom-control custom-switch">
                                                                                                                                                                <input type="checkbox" name="onoffswitch" class="custom-control-input" id="BECStatus<?php echo $ID ?>">
                                                                                                                                                                <label class="custom-control-label" for="BECStatus<?php echo $ID ?>"></label>
                                                                                                                                                        </div>
                                                                                                                                                <?php
                                                                                                                                                }
                                                                                                                                        ...
                                                                                                                                        ?>
                                                                                                                                        <td><button id="btn.<?php echo $TID; ?>" class="btn btn-info btn-sm updatebtn">update</button>
                                        ...
                                        <script>
                                                ...
                                                $(".updatebtn").click(function(e) {
                                                        ...
                                                        if ($(`#OEEStatus${split_value[1]}`).is(':checked')) {
                                                        ...
                                                        if ($(`#BECStatus${split_value[1]}`).is(':checked')) {
                                                        ...
                                                        url = "<?php echo base_url('index.php/main/updatemachine/') ?>" + TID + "/" + OEEStatus + "/" + BECStatus
                                                ...
                                                function updateStatus(value) {
                                                        ...
                                                        alert(id);
                                                        //var RStatus = $('#customSwitch'+split_value).val();
                                                        var RStatus = $(`#customSwitch${id[1]}`).val()
                                                        alert(RStatus);

                                                        // var RStatus = $(`#customSwitch${id}`).val()
                                                        //  var TIDValue = $("#"+id).val()
                                                        //  alert(RStatus);
                                                ...
                                                $(document).ready(function() {
                                                        ...
                                                        function loadSection() {
                                                                ...
                                                                $("#savebtn").click(function() {
                                                                        ...
                                                                        var idealmints = $("#idealmints").val();
                                                                        var Oeetarget = $("#Oeetarget").val();
                                                                        url = "<?php echo base_url("index.php/main/Assignidealmnts/") ?>" + Dept + "/" + section + "/" + idealmints +
                                                                                "/" + Oeetarget
                                                                        //alert(url);
                                                                        $.get(url, function(data) {
                                                                                alert("Team Assign Successfully");
                                                                                location.reload();
                                                                        });
                                                                });
                                                        }
