                                ...
                                <main id="js-page-content" role="main" class="page-content">
                                        ...
                                        <div class="subheader">
                                                <h1 class="subheader-title">
                                                        <i class='subheader-icon fal fa-chart-area'></i> DMMS Machine Ideal Mints Section Wise</span>
                                        ...
                                        <div class="col-lg-12" style="margin-bottom:20px">
                                                ...
                                                <div class="col-12 table-responsive">
                                                        ...
                                                        <div id="panel-1" class="panel">
                                                                <div class="panel-hdr">
                                                                        <h2>
                                                                                DMMS <span class="fw-300"><i>Machine Ideal Mints Section Wise</i></span>
                                                                        </h2>
                                                                                                ...
                                                                                                <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-md-3">
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <label for="team">Enter Ideal Mints</label>
                                                                                                                        <input type="text" class="form-control" id="idealmints"></input>
                                                                                                        ...
                                                                                                        <div class="col-md-3">
                                                                                                                <div class="form-group">
                                                                                                                        ...
                                                                                                                        <label for="team">OEE Target</label>
                                                                                                                        <input type="text" class="form-control" id="Oeetarget"></input>
                                                                                        ...
                                                                                        <div class="table-responsive-lg" id="Data">
                                                                                                <table class="table table-striped table-hover table-sm" id="tableExport">
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                                ...
                                                                                                                ?>
                                                                                                                <?php foreach ($idelMints as $k) : ?>
                                                                                                                        <tr>
                                                                                                                                <td><?php echo $k['DeptName'] ?></td>
                                                                                                                                <td><?php echo  $k['SecName'] ?></td>
                                                                                                                                <td> <?php echo  $k['IdealMints'] ?></td>
                                                                                                                                <td> <?php echo  $k['Target'] ?></td>

                                                                                                                                <?php
                                                                                                                                $TID = $k['TID'];
                                                                                                                                ?>
                                                                                                                                <td><a href="<?php echo base_url("index.php/main/Undo/$TID"); ?>" class="btn btn-danger btn-sm updatebtn">Undo</a></td>
                                                                                                                        </tr>
                                                                                                                <?php endforeach ?>
                                                                                                        </tbody>
                                                                                                </table>
