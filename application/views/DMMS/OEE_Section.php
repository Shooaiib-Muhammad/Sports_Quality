  ...
  <div class="page-content-wrapper">
   ...
   <main id="js-page-content" role="main" class="page-content">
    <ol class="breadcrumb page-breadcrumb">
     ...
     <li class="breadcrumb-item"><a href="#"><?php echo  $DepartmetnName ?></a></li>

     <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>
    <div class="subheader">
     <h1 class="subheader-title">
      <i class='subheader-icon fal fa-chart-area'></i> <?php echo  $DepartmetnName ?></span>
       ...
       <div class="">
        <h3 class="display-4 d-block l-h-n m-0 fw-500">
         ...
         <?php
                                    ...
                                    echo $Activemachines[0]['Count'];


                                    ?>
         <small class="m-0 l-h-n"># Of Active Machine</small>

        </h3>
       </div>

       <i class="fal fa-crosshairs position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4"
      ...
      <div class="p-3 bg-info-300 rounded overflow-hidden position-relative text-white mb-g">
       <div class="">
        <h3 class="display-4 d-block l-h-n m-0 fw-500">
         ...
         <?php
                                    $Totalmachines = $Activemachines[0]['Count'];
                                    //Echo $Activemachines[0]['Count'];
                                    if ($getAvgounter) {
                                        $Downtime = $DaywiseDowntme[0]['Mints'];
                                        $AvgDowntme = $Downtime / $Totalmachines;
                                        echo Round($AvgDowntme, 2);
                                    } else {
                                        echo 0;
                                    }

                                    ?>
         <small class="m-0 l-h-n">Average Downtime</small>
        </h3>
       </div>
       <i class="fal fa-crosshairs position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4"
        style="font-size: 6rem;"></i>
        ...
        <h3 class="display-4 d-block l-h-n m-0 fw-500">
         <?php
                                    if ($getAvgounter) {
                                        ...
                                        $Downtime = $DaywiseDowntme[0]['Mints'];
                                        $AvgDowntme = $Downtime / $Totalmachines;
                                        $Avb = (480 - $AvgDowntme) / 480;
                                        $Availabllity = ($Avb * 100);
                                        echo Round($Availabllity, 2) . '%';
                                    } else {
                                        echo 0;
                                    }

                                    ?>
         <small class="m-0 l-h-n">Availablity</small>
    ...
    <div class="row">
     ...
     <?php
        ...
        $this->load->model('Machine_model', 'machine');
                        ...
                        $DeptID = $keys['DeptID'];
        if ($id == 49) {
          $data['machineCounter'] = $this->model->getStitchingmachine($DeptID);
        } elseif
        ($id == 22) {
          $data['machineCounter'] = $this->model->getStitchingmachine($DeptID);
        } else {
     ...
     <div class="col-md-3">
      <a href="<?php echo base_url("index.php/OEE_machines/OEEmachines/$id") ?>">
        ...
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          <?php
                                            ...
                                            ?>
          <small class="m-0 l-h-n"><?php echo $keys['SecName']; ?></small>
         </h3>
        </div>
     ...
     <div class="settings-panel">
      ...
      <div class="expanded theme-colors pl-5 pr-3">
       <ul class="m-0">
        ...
        <li>
         <a href="#" id="myapp-1" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-1.css"
          data-toggle="tooltip" data-placement="top" title="Tapestry" data-original-title="Tapestry"></a>
        </li>
        <li>
         <a href="#" id="myapp-2" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-2.css"
          data-toggle="tooltip" data-placement="top" title="Atlantis" data-original-title="Atlantis"></a>
        </li>
        <li>
         <a href="#" id="myapp-3" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-3.css"
          data-toggle="tooltip" data-placement="top" title="Indigo" data-original-title="Indigo"></a>
        </li>
        <li>
         <a href="#" id="myapp-4" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-4.css"
          data-toggle="tooltip" data-placement="top" title="Dodger Blue" data-original-title="Dodger Blue"></a>
        </li>
        <li>
         <a href="#" id="myapp-5" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-5.css"
          data-toggle="tooltip" data-placement="top" title="Tradewind" data-original-title="Tradewind"></a>
        </li>
        <li>
         <a href="#" id="myapp-6" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-6.css"
          data-toggle="tooltip" data-placement="top" title="Cranberry" data-original-title="Cranberry"></a>
        </li>
        <li>
         <a href="#" id="myapp-7" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-7.css"
          data-toggle="tooltip" data-placement="top" title="Oslo Gray" data-original-title="Oslo Gray"></a>
        </li>
        <li>
         <a href="#" id="myapp-8" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-8.css"
          data-toggle="tooltip" data-placement="top" title="Chetwode Blue" data-original-title="Chetwode Blue"></a>
        </li>
        <li>
         <a href="#" id="myapp-9" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-9.css"
          data-toggle="tooltip" data-placement="top" title="Apricot" data-original-title="Apricot"></a>
        </li>
        <li>
         <a href="#" id="myapp-10" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-10.css"
          data-toggle="tooltip" data-placement="top" title="Blue Smoke" data-original-title="Blue Smoke"></a>
        </li>
        <li>
         <a href="#" id="myapp-11" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-11.css"
          data-toggle="tooltip" data-placement="top" title="Green Smoke" data-original-title="Green Smoke"></a>
        </li>
        <li>
         <a href="#" id="myapp-12" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-12.css"
          data-toggle="tooltip" data-placement="top" title="Wild Blue Yonder"
          data-original-title="Wild Blue Yonder"></a>
        </li>
        <li>
         <a href="#" id="myapp-13" data-action="theme-update" data-themesave data-theme="css/themes/cust-theme-13.css"
          data-toggle="tooltip" data-placement="top" title="Emerald" data-original-title="Emerald"></a>
        </li>
       </ul>
      </div>
      <hr class="mb-0 mt-4">
