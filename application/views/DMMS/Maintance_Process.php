            ...
            <main id="js-page-content" role="main" class="page-content">
                <ol class="breadcrumb page-breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo base_url(
                                                            ...
                                                            ); ?>">Maintenance Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Accidental / Corrective Maintenance</a></li>
                    <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
                </ol>
                <div class="subheader">
                    <h1 class="subheader-title">
                        <i class='subheader-icon fal fa-chart-area'></i> <span class='fw-300'>Accidental / Corrective Maintenance</span>
                    </h1>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo base_url(
                                        'index.php/Main/issued'
                                    ); ?>">
                            <div class="p-3 bg-warning-400 rounded overflow-hidden position-relative text-white mb-g">
                                <div class="">
                                    <h3 class="display-4 d-block l-h-n m-0 fw-500">
                                        <?php echo $Counter; ?>
                                        <small class="m-0 l-h-n">Issued</small>
                                    </h3>
                                </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo base_url(
                                        'index.php/Main/History'
                                    ); ?>">
                            <div class="p-3 bg-primary-300 rounded overflow-hidden position-relative text-white mb-g">
                                <div class="">
                                    <h3 class="display-4 d-block l-h-n m-0 fw-500">
                                        <?php echo $Hcounter; ?>
                                        <small class="m-0 l-h-n">History</small>
                                    </h3>
                                </div>
                ...
                <form method="post" action="<?php echo base_url(
                                                'index.php/Main/getCustomData?forward=DDMS'
                                            ); ?>">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-2">
                            <div class="form-group mt-4">
                                ...
                                <div class="input-group">
                                    <?php if ($_GET) : ?>
                                        <?php if ($_GET['forward'] == 'DDMS') : ?>
                                            <input class="form-control" type="Date" id="SDate" name="Sdate" value="<?php echo $sdate; ?>" style="width: 100%">
                                        <?php endif; ?>
                                    <?php else : ?>
                        ...
                        <div class="col-md-2">
                            <div class="form-group mt-4">
                                ...
                                <div class="input-group">
                                    <?php if ($_GET) : ?>
                                        <?php if ($_GET['forward'] == 'DDMS') : ?>
                                            <input class="form-control" type="Date" id="EDate" name="Edate" value="<?php echo $sdate; ?>" style="width: 100%">
                                        <?php endif; ?>
                                    <?php else : ?>
...
<script>
    ...
    $("#search").on('click', function() {
        ...
        s_date = $("#SDate").val();
        e_date = $("#EDate").val();
        url = "<?php echo base_url('index.php/Main/getCustomData'); ?>";
        $.post(url, {
            "s_date": s_date,
            "e_date": e_date
        }, function(data) {
            console.log("pakistan", data);
...
<script>
    Highcharts.chart('container', {
        ...
        drilldown: {
            series: [{
                    name: "MACHINE STITCH FIRST FLOOR",
                    id: "MACHINE STITCH FIRST FLOOR",
                ...
                {
                    name: "MACHINE STITCH GROUND FLOOR",
                    id: "MACHINE STITCH GROUND FLOOR",
                    data: <?php echo json_encode(
                                $data_points3,
                                JSON_NUMERIC_CHECK
                            ); ?>,
