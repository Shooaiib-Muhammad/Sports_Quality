        ...
        <ul id="js-nav-menu" class="nav-menu">
            <li class="active open">
                ...
                <ul>
                    ...
                    <li class="active">
                        <a href="<?php echo base_url(
                                        'DMMS/index.php/main/dmms_dashboard'
                    ...
                    <li>
                        <a href="<?php echo base_url(
                                        'DMMS/index.php/DMMS/main/Maintance_Dashboard'
                    ...
                    <?php if ($AdminStatus == 1) { ?>
                        <li>
                            <a href="<?php echo base_url(
                                            'DMMS/index.php/teams/assignTeam'
                                        ); ?>" title="Build Notes" data-filter-tags="application intel build notes">
                        ...
                        <li>
                            <a href="<?php echo base_url(
                                            'DMMS/index.php/main/Idealmachines'
                                        ); ?>" title="Build Notes" data-filter-tags="application intel build notes">
