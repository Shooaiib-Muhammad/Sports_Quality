                            ...
                            <li class="active open">
                                ...
                                <ul>
                                  ...
                                  <li>
                                    ...
                                    <li >
                                        <a href="<?php echo base_url("index.php/teams") ?>" title="Privacy" data-filter-tags="application intel privacy">
 ...
 <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                 <i class='subheader-icon fal fa-chart-area'></i> DMMS Assign Team For SMS</span>
...
<div class="col-12 table-responsive">
   ...
   <div id="panel-1" class="panel">
                                    <div class="panel-hdr">
                                        <h2>
                                            DMMS  <span class="fw-300"><i>Team Member</i></span>
                                        </h2>
    ...
    <label for="team">Select Team member</label>
    ...
    <select  class="form-control" name="team" id="team">
        ...
        <table class="table table-striped table-hover table-sm" id="tableExport">
            ...
            <input type="hidden" name="id" id="TID<?php echo $value->TID; ?>"  value="<?php echo $value->TID; ?>">
            <?php
            $Status=$value->Status;
            $TID=$value->TID;
              $Status;
...
if($Status==1){
 ...
 <div class="custom-control custom-switch">
                                                                <input type="checkbox" name="onoffswitch" class="custom-control-input" id="customSwitch<?php echo $TID ?>" checked>
                                                                <label class="custom-control-label" for="customSwitch<?php Echo $TID ?>"></label>
                                                            </div>
                 <?php
                 ...
                 ?>
 <div class="custom-control custom-switch">
                                                                <input type="checkbox" name="onoffswitch" class="custom-control-input" id="customSwitch<?php Echo $TID ?>" >
                                                                <label class="custom-control-label" for="customSwitch<?php Echo $TID ?>"></label>
                                                            </div>
                 <?php
             }
             ?></td>
             <td><a class="btn btn-info btn-sm updatebtn"  id="up.<?php echo $value->TID;?>">Update</a></td>
                                                             </tr>
                                                              <?php endforeach ?>
                                                     </tbody>
                                </table>
...
$(".updatebtn").click(function(e) {
    ...
    //  var RStatus = $(`#customSwitch${split_value[1]}`).val()
        if($(`#customSwitch${split_value[1]}`).is(':checked')){
...
url = "<?php echo base_url('index.php/Teams/updateStatus/') ?>"+ TID + "/" + checkedValue
...
console.log(html);
 ...
 var Dept = $("#department").val();
  var section = $("#Section").val();
   var teammamber = $("#team").val();
    url = "<?php echo base_url("index.php/teams/AssignTeammember/") ?>" + Dept +"/"+ section +"/"+ teammamber
    //alert(url);
     $.get(url, function(data){
