    ...
    <div class="page-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class='subheader-icon fal fa-chart-area'></i> FGT Adhesion</span>
        ...
        <script>
            ...
            $("#submitData").click(function(e) {
                e.preventDefault();
                if (!fileSelectStore) {
                    toastr["error"]("Please Select FGT Adhesion excel file  to upload", "Error!")
                ...
                fileReader.onload = (e) => {
                    ...
                    filelist.forEach(element => {
                        if (element.TestNo != "" && element.CSSNO != "") {
                            $("#submitData").css("display", "none");
                            $("#sendHeaderValues").css("display", "block");
                            let arrayHead = [element.TestNo, element.TestingDate, element.ReceivingDate, element.CSSNO, element.PONo, element.ArticleNo, element.ArticleName, element.Result, element.TestedBy];
                            ...
                            alert("Test No and CSS No is required in Excel File!");
            ...
            $("#sendHeaderValues").click(function(e) {
                ...
                url = "<?php echo base_url(''); ?>LabController/uploadFgtAdhesion/";
                var fd = new FormData();
