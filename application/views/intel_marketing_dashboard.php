                ...
                <div class="page-content-wrapper">
                 ...
                 <main id="js-page-content" role="main" class="page-content">
                         <ol class="breadcrumb page-breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('index.php/main/Maintance_Dashboard') ?>">Dashboard</a></li>
...
$point1 = array("name" => $key['DeptName']  , "y" => Round($key['Mints']),"drilldown" => $key['DeptName']);
array_push($data_points1, $point1); 
}
//print_r($MachineDowntime);
  $data_points2 = array();
foreach($MachineDowntime as $key) {
$point2 = array("name" => $key['Name'] , "y" => Round($key['Mints']));
    ...
    series: [
        {
            ...
            colorByPoint: true,
            data: 
                 <?php echo json_encode($data_points1, JSON_NUMERIC_CHECK); ?>,   
        }
    ],
    drilldown: {
        series: [
...
<script>
 ...
 Highcharts.chart('container2', {
    ...
    series: [{
        ...
        data: [17.0, 16.6, 14.2, 10.3, 6.6, 4.8]
    },
 {
        name: 'AMB',
        marker: {
        ...
        data: [17.0, 56.6, 98.2, 10.3, 3.6, 4.8]
    },
     {
        name: 'LFB',
        marker: {
        ...
        data: [17.0, 11.6, 14.2, 19.3, 6.6, 15.8]
    },
    {
        name: 'TM',
        marker: {
