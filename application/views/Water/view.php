                   	 ...
                   	 <div class="">
                                <a href="ViewResultFit/totalrequest">    
                                    ...
                                    <h3 class="display-4 d-block l-h-n m-0 fw-500  text-white">
                                      ...
                                      <small class="m-0 l-h-n">Current Water Consumed</small>
									  <?php Echo isset($CallData[0]['Energy'])?> MLtrs
                                  </h3>                                           
                                  </a>
                       </div>                           
                </div>
...
series: [{
	...
	//.data:[1,2,3,4,5]
	data:<?php echo json_encode($GetWater, JSON_NUMERIC_CHECK); ?>
}
],
