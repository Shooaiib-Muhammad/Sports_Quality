                            ...
                            <div id="panel-1" class="panel">
                                ...
                                <div class="panel-container show">
                                    ...
                                    <div class="panel-content">
                                        <?php if (isset($TID)) : ?>
                                            <p class="text-center">Lab did not aknowledged.</p>
                                            <button class="btn btn-primary" style="cursor:pointer" onclick="addAknowledgeCssNo(<?php echo $TID; ?>)">Aknowledge Request</button>
                                            ...
                                            <table class="table table-bordered table-hover table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl  table-striped w-100" id="defaultTable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><span class="badge badge-warning p-1"><?php echo substr($fgtReqData[0]['labAcceptDate'], 0, 11) ?></span></td>
                                                        <td><span class="badge badge-warning p-1"><?php echo $fgtReqData[0]['CssNO'] ?></span></td>
                                                        <td><?php echo $fgtReqData[0]['factoryCode'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['WorkingNo'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['Articleno'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['ModelName'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['Size'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['BallType'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['mainmaterialColor'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['Covermat'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['backing'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['Bladderdetail'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['ProductionMonth'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['Printingcolor'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['panelShape'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['testype'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['testype'] ?></td>
                                                        <td><?php echo $fgtReqData[0]['additionalinfo'] ?></td>
                                                        <td><span class="badge badge-secondary"> <?php if ($fgtReqData[0]['LabStatus'] != 1) : ?>
                                                                    Pending
                                                                <?php else : ?>
                                                                    Aknowledged
                                                                <?php endif; ?>
                                                        ...
                                                        <!-- <td>Receiver Signature</td>
                                                                        <td>Sender Signature</td> -->
                                                        <td><span class="badge badge-warning"><?php if ($fgtReqData[0]['RequestStatus'] != 1) : ?>
                                                                    Send to Lab
                                                                <?php else : ?>
                                                                    Aknowledged By Lab
                                                                <?php endif; ?>
                                                        ...
                                                        <td> <span class="badge badge-danger"><?php echo $fgtReqData[0]['LoginName'] ?> </span></td>
        ...
        $.get(url, function(data) {
            let html = `<table class="table table-bordered table-striped table-hover table-sm" id="fgtTableExport1">
                    ...
                    <tr>
                        ...
                        <tbody>`;
            if (data) {
                if (typeof(data[0]) != "undefined" && typeof(data[0].userid) != "undefined" && data[0].userid == userID) {
                        ...
                        html += `
                            <tr>
                                ...
                                <div class="col-md-2 d-flex ">
                                    ...
                                    <button type="button" style="display: inline-block;" class="btn btn-warning btn-xs updatebtn2" id="" onclick="printFgt(${element.CssNO})"><i class="fal fa-print" aria-hidden="true" ></i></button> &nbsp;
        ...
        $.post(url1, {
            ...
            function(data, status) {
                if (data != '') {
                    ...
                    alert('Lab did not upload excel file of this test type and with matched Css No. Ok bye');
                }
