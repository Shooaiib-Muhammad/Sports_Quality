<aside class="page-sidebar">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                       ...
                       <!--      <a href="#" onclick="return false;" class="pull-trigger-btn" data-action="toggle" data-class="list-filter-active" data-target=".page-sidebar" data-focus="nav_filter_input">
                        ...
                        <?php 
                        $assetStatus= $this->session->userdata('Asset'); 
                         $project= $this->session->userdata('project'); 
                          $Dmms= $this->session->userdata('Dmms'); 
...
?>
                            ...
                            <li >
                                ...
                                <li>
                                        <a href="<?php echo base_url('')?>assetlocation" title="Introduction" data-filter-tags="application intel introduction">
                                            <span class="nav-link-text" data-i18n="nav.application_intel_introduction">Departments</span>
                                        </a>
                                    </li>
                                  
                                    <li>
                                        <a href="<?php echo base_url('')?>AssetsOriginalLife" title="Privacy" data-filter-tags="application intel privacy">
                                            <span class="nav-link-text" data-i18n="nav.application_intel_privacy">Sections</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url('')?>AssetsDepreciationMethod" title="Privacy" data-filter-tags="application intel privacy">
                                            <span class="nav-link-text" data-i18n="nav.application_intel_privacy">Team</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url('')?>vendors" title="Introduction" data-filter-tags="application intel introduction">
                                            <span class="nav-link-text" data-i18n="nav.application_intel_introduction">Reports</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
