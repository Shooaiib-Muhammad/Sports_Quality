                            ...
                            <a href="javascript:void(0)">
                                <div class="p-3 bg-success-300 rounded overflow-hidden position-relative text-white mb-g">
                                    <div class="">
                                        ...
                                        <a style="color:white" href="<?php echo base_url('') ?>Efficiency/realTimeAtten/?dept_id=<?php echo $s['DeptID']?>&section_id=<?php echo $s['SectionID']?>">
                                       <small class="m-0 l-h-n"><?php echo $s['SectionName']?></small>
                                       </a>
                                        </h3>
                                    </div>
...
<script>
    ...
    function realTimeAtten(department,section){
        formURL="<?php echo base_url('Efficiency/realTimeAtten') ?>";
       
        $.ajax({
    url: formURL,
    method: "POST",
    data: {"department":department,"section":section},
