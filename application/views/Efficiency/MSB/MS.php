    ...
    <div class="page-content-wrapper">
      ...
      <main id="js-page-content" role="main" class="page-content">
        ...
        <ol class="breadcrumb page-breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="javascript:void(0);"> Machine Stitch</a></li>
        ...
        <div class="row">
          <div class="col-md-2">
            <a href="<?php echo base_url("Efficiency/CuttingSheetSizing/?dept_id=15&section_id=72") ?>">
              <div style="background-color:rgba(26, 132, 145, 0.7)" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34004" class="m-0 l-h-n"> Sheet Sizing</small>
          ...
          <div class="col-md-2">
            <a href="<?php echo base_url("Efficiency/CuttingBladderWinding/?dept_id=15&section_id=72") ?>">
              <div style="background-color:rgba(26, 132, 145, 0.7)" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34004" class="m-0 l-h-n"> Panel Preparation</small>
          ...
          <div class="col-md-2">
            <a href="<?php echo base_url("Efficiency/CuttingAssembly/?dept_id=15&section_id=72") ?>">
              <div style="background-color:rgba(26, 132, 145, 0.7)" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34004" class="m-0 l-h-n">Assembly</small>
          ...
          <div class="col-md-2">
            <a href="<?php echo base_url("Efficiency/CuttingLabelingAndPacking/?dept_id=15&section_id=72") ?>">
              <div style="background-color:rgba(26, 132, 145, 0.7)" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34004" class="m-0 l-h-n">Labelling & packaging</small>
          ...
          <div class="col-md-2">
            <a href="<?php echo base_url("Efficiency/CuttingPanelCutting/?dept_id=15&section_id=72") ?>">
              <div style="background-color:rgba(26, 132, 145, 0.7)" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34004" class="m-0 l-h-n">Panel CUtting</small>
