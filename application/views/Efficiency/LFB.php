 ...
 <div class="page-inner">
  ...
  <div class="page-content-wrapper">
   ...
   <ol class="breadcrumb page-breadcrumb">
     ...
     <li class="breadcrumb-item"><a href="<?php echo base_url(
                                           'Efficiency/MS'
                                          ); ?>">Laminated FootBall</a></li>

     <!-- <li class="breadcrumb-item"><a href="javascript:void(0);">Sheet Sizing</a></li> -->
    ...
    <div class="subheader">
     <h1 class="subheader-title">
      <i class='subheader-icon fal fa-chart-area'></i> <span class='fw-300'>Laminated FootBall</span>
     </h1>
    ...
    <div class="row">
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("Laminated/carcas") ?>">
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("Laminated/lamination") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#330066">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
         Fabric Lamination
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("Laminated/hfCutting") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#330066">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          HF Cutting
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("Laminated/panelCutting") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#330066">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Panel Cutting
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("Laminated/panelPreparation") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#330066">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Panel Preparation
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("Laminated/assembly") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#330066">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Assembly
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("Laminated/labellingPackaging") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#330066">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Labelling & packaging
