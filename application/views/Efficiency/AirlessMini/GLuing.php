  ...
  <div class="page-content-wrapper">
   ...
   <main id="js-page-content" role="main" class="page-content">
    ...
    <ol class="breadcrumb page-breadcrumb">
     ...
     <li class="breadcrumb-item"><a href="<?php echo base_url(
                                           'Efficiency/AirlessMini'
                                          ); ?>"> Airless Mini Balls</a></li>

     <li class="breadcrumb-item"><a href="javascript:void(0);">Core Gluing</a></li>
     <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
    </ol>

    <div class="subheader">
     <h1 class="subheader-title">
      <i class='subheader-icon fal fa-chart-area'></i> <span class='fw-300'>Core Gluing</span>
     </h1>
    ...
    <div class="row">
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("Efficiency/Gluing/Cutting/?dept_id=15&section_id=72") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:maroon">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Assembly
