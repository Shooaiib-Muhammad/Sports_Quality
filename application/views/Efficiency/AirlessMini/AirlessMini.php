    ...
    <div class="page-content-wrapper">
      ...
      <main id="js-page-content" role="main" class="page-content">
        ...
        <ol class="breadcrumb page-breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="javascript:void(0);"> Airless Mini Balls</a></li>
          <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"></span></li>
        </ol>

        <div class="subheader">
          <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chart-area'></i> <span class='fw-300'>Airless Mini Balls</span>
          </h1>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            ...
            <a href="<?php echo base_url("Efficiency/CuttingCorGluining/?dept_id=15&section_id=72") ?>">
              <div style="background-color:grey" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34001" class="m-0 l-h-n">Core Gluing</small>
          ...
          <div class="col-md-2">
            ...
            <a href="<?php echo base_url("Efficiency/CuttingHF_Cutting/?dept_id=15&section_id=72") ?>">
              <div style="background-color:grey" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34001" class="m-0 l-h-n"> HF Cutting</small>
          ...
          <div class="col-md-2">
            ...
            <a href="<?php echo base_url("Efficiency/CuttingSheetSizingAirless/?dept_id=15&section_id=72") ?>">
              <div style="background-color:grey" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34001" class="m-0 l-h-n"> Sheet Sizing</small>
          ...
          <div class="col-md-2">
            ...
            <a href="<?php echo base_url("Efficiency/CuttingPanelPreparationAirless/?dept_id=15&section_id=72") ?>">
              <div style="background-color:grey" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34001" class="m-0 l-h-n">Panel Preparation</small>
          ...
          <div class="col-md-2">
            ...
            <a href="<?php echo base_url("Efficiency/CuttingAssemblyAirless/?dept_id=15&section_id=72") ?>">
              <div style="background-color:grey" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34001" class="m-0 l-h-n">Assembly</small>
          ...
          <div class="col-md-2">
            ...
            <a href="<?php echo base_url("Efficiency/CuttingFinalCleaningAirless/?dept_id=15&section_id=72") ?>">
              <div style="background-color:grey" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34001" class="m-0 l-h-n"> Final cleaning</small>
          ...
          <div class="col-md-2">
            ...
            <a href="<?php echo base_url("Efficiency/CuttingLabelingAndPackingAirless/?dept_id=15&section_id=72") ?>">
              <div style="background-color:grey" class=" p-2  rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                  <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ...
                    <small id="showValueB34001" class="m-0 l-h-n">Labelling & packaging</small>
