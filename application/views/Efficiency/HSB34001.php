   ...
   <ol class="breadcrumb page-breadcrumb">
    ...
    <div class="subheader">
     <h1 class="subheader-title">
      <i class='subheader-icon fal fa-chart-area'></i> <span class='fw-300'>Hand Stitch Ball</span>
     </h1>
    ...
    <div class="row">
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("HSB/carcas") ?>">
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("HSB/lamination") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#997300">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Lamination
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("HSB/SheetSizing") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#997300">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Sheet Sizing
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("HSB/panelCutting") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#997300">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Panel Cutting
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("HSB/panelPreparation") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#997300">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Panel Preparation
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("HSB/assembly") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#997300">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Assembly
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("HSB/labellingPackaging") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:#997300">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Labelling & packaging
