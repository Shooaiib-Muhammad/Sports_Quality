   ...
   <ol class="breadcrumb page-breadcrumb">
    ...
    <div class="subheader">
     <h1 class="subheader-title">
      <i class='subheader-icon fal fa-chart-area'></i> <span class='fw-300'>Airless Mini Ball</span>
     </h1>
    ...
    <div class="row">
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("AMB/SheetSizing") ?>">
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("AMB/hfCutting") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:maroon">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          HF Cutting
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("AMB/assembly") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:maroon">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Assembly
     ...
     <div class="col-sm-6 col-xl-3">
      <a href="<?php echo base_url("AMB/labellingPackaging") ?>">
       <div class="p-3 rounded overflow-hidden position-relative text-white mb-g" style="background-color:maroon">
        <div class="">
         <h3 class="display-4 d-block l-h-n m-0 fw-500">
          Labelling & packaging
