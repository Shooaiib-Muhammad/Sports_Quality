                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <div>
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="<?php echo base_url('./'),'DashboardController/B34001'; ?>">Hand Stich Ball</a></li>
                    ...
                    <i class='subheader-icon fal fa-chart-area'></i> Hand Stich Ball</span>
                    ...
                    <script src="https://code.highcharts.com/modules/accessibility.js"></script>
                        ...
                        <figure class="highcharts-figure01">
...
?>
  ...
  series: [{
    name: 'Articles Wise',
    colorByPoint: true,
    data: <?php echo json_encode(   $B34001data_points2,
                                                JSON_NUMERIC_CHECK
                                            ); ?>,
    // data: [
    //     <?php echo json_encode($B34001data_points2, JSON_NUMERIC_CHECK); ?>
    //   ['Shanghai', 24.2],
    //   ['Beijing', 20.8],
    //   ['Karachi', 14.9],
    //   ['Shenzhen', 13.7],
