    ...
    <div class="page-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class='subheader-icon fal fa-chart-area'></i> FGT Airless Mini</span>
                    ...
                    <div class="col-lg-12" style="margin-bottom:20px">
                        ...
                        <div class="col-md-12  table-responsive">
                            ...
                            <div id="panel-1" class="panel">
                                <div class="panel-hdr">
                                    <h2>
                                        FGT Airless Mini Test Report</span>
                                    </h2>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3"><button class="btn btn-primary" id="searchFGTtestAirlessMini">Search</button></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-container show">
                        ...
                        <script>
                            ...
                            $('#searchFGTtestAirlessMini').on('click', function() {
                                var date1 = $("#date1").val();
                                var date2 = $("#date2").val();

                                url = '<?php echo base_url('LabController/getFGTTestDataForViewAirlessMini'); ?>';
                                $.post(url, {
                                    'date1': date1,
                                    'date2': date2
                                }, function(data) {
        ...
        <script>
                ...
                toastr.options = {
                    ...
                    "onShown": function() {
                            ...
                            fileReader.onload = (e) => {
                                ...
                                filelist.forEach(element => {
                                    if (element.LABNO != "" && element.CSSNO != "") {
                                        ...
                                        let arrayBody = [element.TEST, element.METHOD, element.CONDITION, element.UNIT, element.AirlessMiniSoccerball, element.BALL1, element.BALL2, element.BALL3, element.BALL4, element.BALL5, ']'];
                        ...
                        $("#cancelButton").click(function() {
                            toastr.warning("Check file formate and the try again!");
                            return;
                        });
                    }
                }

                toastr.info("Are you sure this file formate is for FGT Airless Mini? </br> <button id='confirmButton' class='btn btn-success'>Yes</button> <button id='cancelButton' class='btn btn-danger'>No</button>", "Confirmation");
            ...
            $("#sendHeaderValues").click(function(e) {
                ...
                url = "<?php echo base_url(''); ?>LabController/uploadFgtAirlessMini/";
                var fd = new FormData();
