...
<div class="col-12 table-responsive">
    <div class="row">
        <div class="col-md-6">
            <a href="<?php echo base_url("index.php/teams/newteam") ?>" class="btn btn-success mb-3"> Create New</a>
        </div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $f->CardNo ?></td>
                 <form method="post" action="<?php echo base_url("index.php/Teams/update")?>">
                <td>
            <input type="text" class="form-control" name="Phone" value="<?php echo $f->Phone ?>"></td>
                <td>
                    <input type="text" name="Email"  class="form-control"  value="<?php echo $f->Email ?>"></td>
            ...
            <div class="form-group">
                    ...
                    <select class="form-control" name="Skill" id="skill">
                        ...
                        <option value="<?php echo $f->SkillID ?>"><?php echo $f->SkillName ?></option>
...
if($Status==1){
 ...
 <div class="custom-control custom-switch">
                                                                <input type="checkbox" name="onoffswitch" class="custom-control-input" id="customSwitch<?php Echo $ID ?>" checked>
                 ...
                 ?>
 <div class="custom-control custom-switch">
                                                                <input type="checkbox" name="onoffswitch" class="custom-control-input" id="customSwitch<?php Echo $ID ?>" >
                                                                <label class="custom-control-label" for="customSwitch<?php Echo $ID ?>"></label>
                                                            </div>
                 <?php
             }
