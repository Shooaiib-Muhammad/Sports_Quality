        ...
        <div class="page-inner">
            ...
            <div class="page-content-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <!--Edit FGT CSS NoREQUEST MODAL -->
                    <div id="editCssModal" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: rgb(83,78,130);color:white;font-weight:bolder">
                                    <h1 class="modal-title" id="changeTitle">FGT Request update Css No</h1>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true" style="color: white;">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form name="formDepartment" id="" method="POST">
                                        ...
                                        <div class="row" style="display:flex">
                                            <input type="hidden" id="editFGTId">
                                            ...
                                            <div class="col-md-6">
                                                <label for="customFile">CSS No</label>
                                                <input type="text" class="form-control" id="editcssno" name="editcssno">
                                            </div>
                                        ...
                                        <div class="col-md-6 mt-4">
                                            ...
                                            <button class="btn btn-primary" id="updateBtnCssNo">Update</button>
                    ...
                    <!--End EDIT FGT CSS No REQUEST MODAL -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" id="qrcodePrint">
                                    <div style="display: flex;flex-wrap: wrap; justify-content:flex-center" id="qrcodeData">
...
let dataTable;
        function loadFGTRequestwithCssNo() {
            ...
            <td><button class="btn btn-primary btn btn-sm" onclick="editCssNo(${element.TID},'${element.CssNO}')"><i class="fal fa-edit"></i></button></td>
                ...
                for (var i = 0; i < selectedRows.length; i++) {
                    selectedText += `
                        ...
                        <div style="flex: 0 0 60px;">
                            ...
                            <br>                       
                            <span style=padding-left:20px;margin-top:0px;> <b>Css No: ` + selectedRows[i].cssno + `</b></span>
                        </div>
        ...
        function editCssNo(TID, cssno){
            // console.log(TID)
            // console.log(cssno)
            $("#editFGTId").val(TID);
            $("#editcssno").val(cssno);
            $("#editCssModal").modal('toggle');

        }
        $("#updateBtnCssNo").on('click', function(e){
            e.preventDefault();

            let TID = $("#editFGTId").val();
            let cssNo = $("#editcssno").val();
            // console.log(TID)
            // console.log(cssNo)
            if(cssNo != ''){
                url = "<?php echo base_url(''); ?>LabController/updateCssNoFGTRequest";
                $.post(url, {
                    TID: TID,
                    cssNo: cssNo,
                }, function(data) {
                    if (data == true) {
                        $('#editCssModal').modal('toggle');
                        alert("CssNo updated successfully");
                        loadFGTRequestwithoutCssNo();
                        loadFGTRequestwithCssNo();
                    }else{
                ...
                alert('Css No is required to update');
            }
        });
    ...
    <script>
        ...
        $("#save1").click(function() {
            ...
            if (recDate1.length <= 0 || cssNo1.length <= 0 || qReceived1.length <= 0 || qRetained1.length <= 0 || dueDate1.length <= 0 || compDate1.length <= 0 || sSignature1.length <= 0) {
