          ...
          $(document).ready(function() {
            ...
            Highcharts.chart('MSEfficiency', {
              ...
              series: [{
                type: 'column',
                name: 'Efficiency',
                data: [<?php echo $BladderWInding; ?>, <?php echo $Sheetsizing; ?>, <?php echo $PanelCutting; ?>, <?php echo $Stitchinglines; ?>, <?php echo $RWPD; ?>]
            ...
            Highcharts.chart('TMEfficiency', {
              ...
              series: [{
                type: 'column',
                name: 'Efficiency',
                data: [<?php echo $tmcarcasCount; ?>, <?php echo $TMLamination; ?>, 0, <?php echo $TMpacking; ?>, <?php echo $TMpacking; ?>]
