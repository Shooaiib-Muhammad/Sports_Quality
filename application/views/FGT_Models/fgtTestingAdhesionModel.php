<div class="modal fade bd-example-modal-lg" id="fgtTestingAdhesionModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card" id="printCardFGTTestingAdhesion">
                    <div class="card-body">
                        <div class="row">
                            <div class="table" style="display: flex; justify-content:space-between">
                                ...
                                <div style="font-size: medium; font-weight:bold; padding-top:40px; text-align:center;">
                                    ...
                                    <h3 style="font-weight:bold;margin-top:30px;">Test Report of FGT Adhesion</h3>
                                </div>
                            ...
                            <div style="display:flex;margin-left:170px;margin-top:5%" >
								...
								<div style="padding-left:30px;padding-right:30px;line-height:3.0">
                                    <table border="1">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Result</td>
                                                <th style="text-align: center;" id="resultFGTAdhesion"></th>
                                            </tr>
                                            <tr>
                                                <td>Tested By</td>
                                                <th style="text-align: center;" id="testedByFGTAdhesion"></th>
                                            </tr>
                            ...
                            <br>
                            <div style="margin-top: 10px;margin-bottom: 10px; margin-left:170px;padding-right:30px;line-height:3.0">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="printDiv('printCardFGTTestingAdhesion')" data-dismiss="modal">Print Report</button>
            </div>
