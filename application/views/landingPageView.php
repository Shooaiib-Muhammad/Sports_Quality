                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card title" >
                                    <h1 class="text-center font-weight-bold bg-warning" style="font-size: 2rem;">Welcome to Forward Sports MIS System</h1>
                                </div>
                                <div class="card-body">
                                    <div style="background-color: #ddd;">
                                        <video style="width: 100%; height: 100vh" loop autoplay muted controls id="vid">
                                            <source src="<?php echo base_url('assets/pexels-cottonbro-10349005.mp4') ?>" type="video/mp4">
                                        </video>
                                    </div>
                                </div>
                            </div>
