        ...
        <main id="js-page-content" role="main" class="page-content">
          ...
          <div class="subheader">
            <h1 class="subheader-title">
              <i class='subheader-icon fal fa-chart-area'></i> Ball Type</span>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header" style="background-color: rgb(83,78,130);color:white;font-weight:bolder">
                  <h1 class="modal-title" id="changeTitle">Add New Ball</h1>
                ...
                <div class="modal-body">
                  <form enctype="multipart/form-data" id="" method="POST" action="<?php echo base_url(''); ?>UploadResult/Submit">
                    ...
                    <label class="form-contol" for="customFile">Ball Name:</label>
          ...
          <div id="panel-1" class="panel">
            <div class="panel-hdr">
              <h2>
                <i class='subheader-icon fal fa-vial'></i> Ball Type</span>
              </h2>

              <button type="button" class="btn btn-primary" style="float:right;" data-toggle="modal" data-target="#Modaldepartment" class="d-grid gap-2 d-md-block" id="createDepartment">+ Create New Ball</button>
            </div>
