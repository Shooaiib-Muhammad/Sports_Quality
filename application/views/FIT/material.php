...
?>
        ...
        <main id="js-page-content" role="main" class="page-content">
          ...
          <div class="subheader">
            <h1 class="subheader-title">
              <i class='subheader-icon fal fa-chart-area'></i> Material Type</span>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header" style="background-color: rgb(83,78,130);color:white;font-weight:bolder">
                  <h1 class="modal-title" id="changeTitle">Add New Material</h1>
                ...
                <div class="modal-body">
                  <form  >
                    ...
                    <label class="form-contol" for="customFile">Material Name:</label>
                    ...
                    <div class="row">
                      <div class="form-group">
                        <div>
                          <button type="button" class="btn btn-primary m-3" id="savebtn">Save</button>
          ...
          <div id="Modalmaterial" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header" style="background-color: rgb(83,78,130);color:white;font-weight:bolder">
                  <h1 class="modal-title" id="changeTitle">EDIT  Material</h1>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" style="color: white;">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form  >
                    ...
                    <input style="display:none" type="text" class="form-control" id="idNew" name="idNew">
                    <div class="col-md-12">
                    <div class="col-md-12">

                    <label class="form-contol" for="customFile">Material Name:</label>
                    <input type="text" class="form-control" id="mnamee" name="mname">

                    </div>
                      <div class="col-md-12 mt-4">

                        <div class="custom-control custom-switch">
                          <input type="checkbox" class="custom-control-input" id="mstatus" name="status">
                    ...
                    <div class="row">
                      <div class="form-group">
                        <div>
                          <button type="button" class="btn btn-primary m-3" id="updateM">Update</button>
          ...
          <div id="panel-1" class="panel">
            <div class="panel-hdr">
              <h2>
                <i class='subheader-icon fal fa-vial'></i> Material Type</span>
              </h2>

              <button type="button" class="btn btn-primary" style="float:right;" data-toggle="modal" data-target="#Modaldepartment" class="d-grid gap-2 d-md-block" id="createDepartment">+ Create New Material</button>
            </div>
 ...
 if(status=='true'){
     ...
     status=0
      ...
      url="<?php echo base_url('MaterialType/submit') ?>"

      $.post(url,{"Mname":Mname,"status":status},function(data){
  ...
  <script>
      $(document).ready(function(){
        url="<?php echo base_url('MaterialType/getdata') ?>"
...
<tr>
  <td>${e.Name} </td>
  <td> ${e.Status}</td>
  <td><button type="button"  class="btn btn-info" onclick="editrecord(${e.TID})">Edit</button></td>
...
$("#tableData").html(table);
  console.log("data from table",data);
     ...
     function editrecord(id){
        url="<?php echo base_url('MaterialType/singleRecord') ?>"
         $.post(url,{"id":id},function(data){

            console.log("edit record",data)
            $("#mnamee").val(data[0]['Name']);
            $("#idNew").val(data[0]['TID']);
            if(data[0]['Status']==1){
     ...
     $("#updateM").on('click',function(){
        let Mname = $("#mnamee").val();
      let status =  $('#mstatus').prop('checked');
      let id=$("#idNew").val();
 ...
 if(status=='true'){
     ...
     status=0
      ...
      url="<?php echo base_url('MaterialType/updateMaterial') ?>"

      $.post(url,{"id":id,"Mname":Mname,"status":status},function(data){
