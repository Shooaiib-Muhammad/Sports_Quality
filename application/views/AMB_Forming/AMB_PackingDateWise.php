      ...
      <ol class="breadcrumb page-breadcrumb">
                ...
                <div class="subheader">
                    <h1 class="subheader-title">
                        <i class='subheader-icon fal fa-chart-area'></i> <span class='fw-300'>AMB Packing</span>
                    </h1>
      ...
      //  if(SDate)
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="<?php echo base_url('AMB_Packing/AMB_Packing/searchData') ?>">
              <div class="row clearfix">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input class="form-control" type="Date" id="EDate" name="Edate" value="<?php echo $EDate; ?>" style="width: 100%">
                    </div>
                  </div>
                </div>
