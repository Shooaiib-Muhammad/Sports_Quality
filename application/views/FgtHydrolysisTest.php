            ...
            <div class="page-content-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    <ol class="breadcrumb page-breadcrumb">
                        <!-- <ol class="breadcrumb-item"><a href="<?php echo base_url(
                                                                        'index.php/main/dmms_dashboard'
                                                                    ); ?>">FGT Circumference Testing</a></ol> -->
                    ...
                    <div class="col-lg-12" style="margin-bottom:20px">
                        ...
                        <div class="col-md-12  table-responsive">
                            ...
                            <div id="panel-1" class="panel">
                                <div class="panel-hdr">
                                    <h2>
                                        FGT Hydrolysis Test Report</span>
                                    </h2>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                        ...
                        <script>
                            ...
                            $('#searchFGTtest').on('click', function() {
                                ...
                                url = '<?php echo base_url('LabController/getFGTHydrolysis'); ?>';
                                $.post(url, {
                                    'date1': date1,
                                    'date2': date2,
                                    'factoryCode': factoryCode
                                }, function(data) {
                                    console.log("hydrolysis", data);
