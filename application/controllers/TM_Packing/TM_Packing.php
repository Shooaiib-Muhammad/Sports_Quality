...
// die;
 ...
 public function searchData()
 {
  ...
  $data['Counter'] = $this->TM_Packing_Model->TotalCounter($StartDateeee, $EndDateeee);

  $data['Throsters'] = $this->TM_Packing_Model->Throsters($StartDateeee, $EndDateeee);
  // print_r($data['Counter']);
  // die;
  $data['SDate'] =$_POST['Sdate'];
  $data['EDate'] =$_POST['Edate'];
  $this->load->view("TM_Packing/TM_PackingDateWise", $data);
