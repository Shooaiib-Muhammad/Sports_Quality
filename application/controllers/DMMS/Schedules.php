...
class Schedules extends CI_Controller {
    public function __construct()
    {
        ...
        $this->load->model('DMMS/Schedule_model', 'model');
    ...
    public function index()
    {
        ...
        $this->load->view("DMMS/schedules", $data);
    }
...
$data['Name']=$Name;
 $data['DeptName']=$DeptName;
  ...
  $data['title'] = $DeptName." / ". $SecName ." Schedule";
        ...
        $this->load->view("DMMS/new_schedule", $data);
    }
    ...
    public function maintenance()
    {
        ...
        $this->load->view("DMMS/sample", $data);
    }

    public function inventory()
    {
        $data['title'] = 'Parts Inventory';
        $this->load->view("DMMS/isample", $data);
    }
 ...
 // Die;
  $data['title'] = $DeptName." / ". $SecName ." / ". $Name ." / ". " Maintance";
     //$data['title'] = 'Working Maintenance.' $';
        $this->load->view("DMMS/getworking", $data);
}
